...
- **Consulta Fato Original**: Média de **8,77 ms** por consulta.
- **Consulta Tabela Agregada**: Média de **4,00 ms** por consulta.

Isso representa um ganho médio de velocidade de **2,19 vezes** na renderização e recuperação de relatórios analíticos anuais agrupados.
